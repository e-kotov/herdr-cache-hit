...
transmitted. AGY prefers the packaged native Go decoder for its read-only
SQLite conversation database and falls back to transcript parsing only when no
native database is available.
